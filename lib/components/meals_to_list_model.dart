...
class MealsToListModel extends FlutterFlowModel<MealsToListWidget> {
  ...
  Map<MealsRecord, bool> checkboxValueMap1 = {};
  List<MealsRecord> get checkboxCheckedItems1 => checkboxValueMap1.entries
      .where((e) => e.value)
      .map((e) => e.key)
      .toList();

  // State field(s) for Checkbox widget.
  Map<MealsRecord, bool> checkboxValueMap2 = {};
  List<MealsRecord> get checkboxCheckedItems2 => checkboxValueMap2.entries
      .where((e) => e.value)
      .map((e) => e.key)
      .toList();

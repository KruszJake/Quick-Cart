...
class _MealsWidgetState extends State<MealsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MEALS_PAGE_meals_ON_INIT_STATE');
      logFirebaseEvent('meals_update_app_state');
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'MEALS_PAGE_arrow_forward_ICN_ON_TAP');
                                    logFirebaseEvent('IconButton_navigate_to');

                                    context.pushNamed(ItemsWidget.routeName);
                                  },
                                ),
                              ),
                                      ...
                                      FFButtonWidget(
                                        ...
                                        onPressed: () async {
                                          ...
                                          logFirebaseEvent(
                                              'addMeal_reset_form_fields');
                                          safeSetState(() {
                                            _model.mealTypeValueController
                                                ?.reset();
                                          });
                                        },
                                        text: 'Add Meal',
                      ...
                      children: [
                              ...
                              fieldViewBuilder: (
                                ...
                                return TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    ...
                                    () async {
                                      logFirebaseEvent(
                                          'MEALS_PAGE_Search_ON_TEXTFIELD_CHANGE');
                                      logFirebaseEvent('Search_simple_search');
                                      safeSetState(() {
                        ...
                        Align(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent('MEALS_PAGE_clear_ICN_ON_TAP');
                              logFirebaseEvent(
                    ...
                    if (!FFAppState().searchactive)
                      Builder(
                        builder: (context) {
                          final nosearch = mealsMealsRecordList.toList();

...
import '/components/survey_prompt_widget.dart';
...
class _MealsWidgetState extends State<MealsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'meals'});
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    ...
                                    onPressed: () async {
                                      ...
                                      logFirebaseEvent(
                                          'addMeal_update_page_state');
                                      _model.clickCount =
                                          _model.clickCount! + 1;
                                      safeSetState(() {});
                                      if (_model.clickCount! >= 6) {
                                        logFirebaseEvent(
                                            'addMeal_bottom_sheet');
                                      ...
                                      logFirebaseEvent(
                                          'addMeal_reset_form_fields');
                                      safeSetState(() {
                                        _model.ingredientsTextController
                                            ?.clear();
                                        _model.caloriesTextController?.clear();
                                        _model.mealNameTextController?.clear();
                                      });
                                      logFirebaseEvent(
                                          'addMeal_reset_form_fields');
                                      safeSetState(() {
                                        _model.mealTypeValueController?.reset();
                                      });
                                    },
                                    text: 'Add Meal',
